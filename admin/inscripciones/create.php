                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="grado_id" id="grado_select" class="form-control">
                                                ...
                                                foreach ($grados as $grado){ ?>
                                                    <option value="<?=$grado['id_grado'];?>" data-nivel-id="<?=$grado['nivel_id'];?>"><?=$grado['curso']." | Paralelo ".$grado['paralelo'];?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                        ...
                        <div class="card card-outline card-danger">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Correo del Padre (Usuario)</label>
        ...
        allGrados.forEach(option => {
            if (option.getAttribute('data-nivel-id') === selectedNivel || !option.getAttribute('data-nivel-id')) {
                ...
                if (!firstMatch && option.getAttribute('data-nivel-id')) {
                    clonedOption.selected = true; // Auto-select the first valid grade
                    firstMatch = true;
                }
            }
        });
