                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="../estado_cuenta/paz_y_salvo.php?id_estudiante=<?=$id_estudiante;?>" target="_blank" type="button" class="btn btn-success btn-sm"><i class="bi bi-file-earmark-pdf"></i> Imprimir Paz y Salvo</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php
